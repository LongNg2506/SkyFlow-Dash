...
import { setAuthCookieFromIdToken } from "@/lib/firebase/auth-actions"
import { ensureUserProfileFromAuth } from "@/modules/users/services/user-services"
...
export function SignupForm1({
  ...
  async function onSubmit(data: SignupFormValues) {
    ...
    try {
      const credential = await signUpWithEmailPassword(data.email, data.password, displayName)
